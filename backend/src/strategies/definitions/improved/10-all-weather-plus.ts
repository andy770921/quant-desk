...
/**
 * Improved All-Weather: inverse-vol risk parity across the sleeves (true Dalio
 * spirit) plus a 200-SMA trend overlay that moves equity risk to a trending
 * Treasury when stocks are below trend.
 */
export const allWeatherPlus: StrategyDefinition = {
  id: 'all-weather-plus',
  name: '全天候風險平衡（改良版）',
  shortName: '全天候+',
  category: 'diversified',
  description:
    '改用反波動度風險平價配置各資產，並加上股票 200 日均線疊加濾網，空頭時把股票風險移轉至趨勢公債。',
  longDescription:
    '原版全天候的改良。把固定的 30/40/15/15 改為反波動度風險平價——每個資產權重與其波動度成反比，使各資產的風險貢獻更均衡，' +
    '提升 Sharpe；再加上股票腳本的 200 日均線疊加濾網：當標普跌破均線時，把原本配給股票的權重移轉到趨勢較強的公債，降低股市主導的回撤。',
  rules: [
  ...
  caveats: ['債券權重通常偏高，升息環境較吃虧。', '反波動度權重對波動估計敏感。'],
  signalFormula: [
